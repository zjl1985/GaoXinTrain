...
<head>
    ...
    <!--页面级样式-->
    <link href="<%=request.getContextPath()%>/assets/global/plugins/datatables/datatables.min.css" rel="stylesheet"
          type="text/css"/>
    ...
    <div class="page-sidebar-wrapper">
        <div class="page-sidebar navbar-collapse collapse">
            <ul class="page-sidebar-menu page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                ...
                <li class="nav-item nav-top-menu">
                    <a href="#" class="nav-link nav-toggle"><i class="fa fa-tree"></i><span
                            class="title">培训1</span><span class="arrow"></span></a>
                    <ul class="sub-menu">
                        <li class="nav-item">
                            <a href="#" url="messagelog/messagelog.jsp"
                        ...
                        <li class="nav-item">
                            <a href="#" url="demo1/demo1.jsp"
                               data-addtab="a8890322-c2224c9-41fe-9c3b-0c6df07319e5" class="nav-link nav-toggle">
                                <i class="fa fa-braille"></i><span class="title">菜单121212</span>
                            </a>
                        </li>
                    </ul>
                </li>
